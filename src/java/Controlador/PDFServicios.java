 ...
 * @author Sergio
 */
@WebServlet(name = "PDFServicios", urlPatterns = {"/PDFServicios"})
public class PDFServicios extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<solicitudesServiciosDTO> servi =  (List<solicitudesServiciosDTO>) miSession.getAttribute("servicios");
        try {

            JasperReport reporte = (JasperReport) JRLoader.loadObject(getServletContext().getRealPath("WEB-INF/serviciosSolicitadosDTO.jasper"));
            JasperPrint jasperPrint = JasperFillManager.fillReport(reporte, null, new JRBeanCollectionDataSource(servi));
