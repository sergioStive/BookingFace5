...
<nav> 
    <ul id="main"> 
<li>
    <div align="center" ><a href="index1.jsp" style="text-decoration: none;"><span class="glyphicon glyphicon-home"></span> initiation</a>
</div>
</li>	
</ul>
    </nav> 
...
<label for="correo" class="labele"><strong>Mail<font color="#FF0000">*</strong></label></font>
